...
var rencode_legacy_mode = true
export function rencodelegacy(obj) {
  rencode_legacy_mode = true
  return rencode(obj)
}
export function rencode(obj) {
...
export function rencodeplus(obj) {
...
function rdecode_intb(dec) {
  ...
  const b = (dec.buf[dec.pos + 1] << 24) >> 24
  dec.pos += 2
  return b
}
